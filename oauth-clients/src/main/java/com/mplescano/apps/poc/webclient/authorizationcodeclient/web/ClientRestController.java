package com.mplescano.apps.poc.webclient.authorizationcodeclient.web;
...
public class ClientRestController {
    ...
    private static final String RESOURCE_URI = "http://localhost:8088/spring-security-oauth-resource/foos/1";
