package com.mplescano.apps.poc.webclient.authorizationcodelogin;
 ...
 *
 */
@PropertySource(value = "classpath:webclient-auth-code-login-application.yml", factory = YamlPropertyLoaderFactory.class)
