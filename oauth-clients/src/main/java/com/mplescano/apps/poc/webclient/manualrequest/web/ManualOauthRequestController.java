package com.mplescano.apps.poc.webclient.manualrequest.web;
...
public class ManualOauthRequestController {
    ...
    private static final String RESOURCE_ENDPOINT = "localhost:8088/spring-security-oauth-resource/foos/1";
