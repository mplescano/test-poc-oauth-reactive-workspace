package com.mplescano.apps.poc.webclient.clientcredentials.service;
...
public class WebClientChonJob {
    ...
    private static final String RESOURCE_URI = "localhost:8088/spring-security-oauth-resource/foos/1";
